...
def __decision_plot_matplotlib(
    ...
    if color_bar:
        ...
        ax_cb = ax.inset_axes(
            [xlim[0], feature_display_count, xlim[1] - xlim[0], 0.25], transform=ax.transData
        )
